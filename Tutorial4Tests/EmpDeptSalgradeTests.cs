...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnAllSalesmen()
    {
        ...
        List<Emp> result = (from e in emps where e.Job == "SALESMAN" select e).ToList(); 
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result = (from e in emps join d in depts on e.DeptNo equals d.DeptNo select new { e.EName, d.DName }).ToList(); 
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = (from e in emps where e.Comm != null select new {e.EName, e.Comm}).ToList(); 
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = ( from e in emps group e by e.DeptNo into g select new {DeptNo = g.Key,   AvgSal = g.Average(e => e.Sal)}).ToList(); 
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = (from e in emps where e.Sal >(emps.Where(i => i.DeptNo == e.DeptNo).Average(inner => inner.Sal )) select e.EName).ToList(); 
